...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("user", JSON.stringify(response.datagit));
      navigate("/");
    } catch (error) {
      if (error.response) {
  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950">
      <div className="h-screen container mx-auto flex items-center justify-center text-white">
        ...
        {/* Login Form */}
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg w-[350px] m-8 md:m-0 mt-20">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  type={isPasswordVisible ? "text" : "password"} // Show password as text when toggled
                  id="password"
                  value={password}
                ...
                >
                  {isPasswordVisible ? "🙈" : "👁️"} {/* Change icon based on visibility */}
                </span>
              </div>
            </div>
            {errorMessage && (
