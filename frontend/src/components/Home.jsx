      ...
      <div className="h-[1400px] md:h-[1300px] text-white container mx-auto">
        ...
        <header className="flex items-center justify-between p-6 ">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <h1 className="md:text-3xl text-orange-500 font-bold">
                CourseHaven
              </h1>
            </div>
            <Link
                ...
                <div className="relative w-full h-80 md:w-72 mx-auto transition-transform duration-500 transform hover:scale-105 hover:shadow-xl">
                  <div className="bg-gradient-to-r from-indigo-600 via-blue-700 to-purple-800 rounded-lg overflow-hidden shadow-lg h-full flex flex-col">
                    ...
                    <div className="p-4 text-center flex-1 flex flex-col justify-between">
                      ...
                      <p className="text-md text-gray-300 mt-2 truncate">
                        {course.description}
                      </p>
                      <Link
                        to={`/buy/${course._id}`}
        ...
        <section className="bg-orange-500 py-12 text-center text-white">
          ...
          <p className="mt-4 text-lg">
            Join thousands of learners and advance your career today!
          </p>
          <Link
            to="/signup"
            className="mt-6 pt-1 bg-black text-white py-3 px-6 rounded-full text-xl hover:bg-white hover:text-black transition duration-300"
          >
            Get Started
          </Link>
        </section>
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="mt-4">
                ...
                <div className="flex space-x-6">
                  ...
                  <a
                    href="#"
                    className="hover:text-pink-600 text-xl transition duration-300"
                  >
                    <FaInstagram />
                  </a>
                  <a
                    href="#"
                    className="hover:text-blue-600 text-xl transition duration-300"
                  >
                    <FaTwitter />
                  </a>
                </div>
